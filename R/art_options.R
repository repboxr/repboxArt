...
repbox_art_opts = function(journ_format = NULL, overwrite=FALSE,single_line_regs = FALSE, few_integer_as_text_limit = 5, not_implemented_action=c("error","warn","msg","nothing")[1]) {
  list(
    overwrite = overwrite,
