...
repbox_art_opts = function(journ_format = NULL, overwrite=FALSE,single_line_regs = FALSE, few_integer_as_text_limit = 5, not_implemented_action=c("error","warn","msg","nothing")[3], detection_problem=c("error","warn","msg","nothing")[3], preferred_route="html") {
  list(
    overwrite = overwrite,
